...
client5.login(process.env.TOKEN);
clien6.login(process.env.TOKEN);
client7.login(process.env.TOKEN);
client8.login(process.env.TOKEN);
client9.login(process.env.TOKEN);
client10.login(process.env.TOKEN);
